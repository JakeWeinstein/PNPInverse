...
| `exponent_clip` | `bv_convergence.exponent_clip` | `100.0` | Symmetric clamp on `eta_scaled = (V_RHE − E_eq)/V_T` *before* the α·n_e multiplication. Raised from 50 → 100 on 2026-05-04 because clip=50 sign-flips PC at V_RHE < −0.1 V. See `docs/clipping_conventions.md`. |
