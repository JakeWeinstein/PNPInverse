...
Three threads: (1)~a full codebase restructure,
(2)~building and validating a general-purpose Poisson--Nernst--Planck (PNP) forward
solver with multi-reaction Butler--Volmer (BV) boundary conditions, and
(3)~an extensive convergence study demonstrating mesh independence, parameter
sensitivity, and solver robustness across 29 separate runs.
...
%% ============================================================
\section*{5. Results: I--V Curve and Species Profiles}
%% ============================================================

\subsection*{5.1 I--V curve}
...
at the electrode.
Unlike the uncharged 2-species model (\S6), the peroxide current does
\emph{not} spike and collapse --- H$^+$ depletion caps both reactions simultaneously.


\subsection*{5.2 Species and potential profiles}
...
\subsection*{5.3 Comparison with neutral 2-species model}
...
%% ============================================================
\section*{6. Bugs Found and Fixed}
%% ============================================================
...
%% ============================================================
\section*{7. Uncharged Validation Models (Summary)}
%% ============================================================
...
\subsection*{6.1 Single-species (O$_2$ only)}
...
\subsection*{6.2 Two-species (O$_2$ + H$_2$O$_2$, neutral)}
...
(the 4-species model of \S2--\S4).


%% ============================================================
\section*{7. Discussion and Next Steps}
%% ============================================================

\textbf{Solver quality.}
The 29-run convergence study demonstrates:
\begin{itemize}
