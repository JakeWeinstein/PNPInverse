...
\caption{Computational domain representing the diffusion layer above a
  ...
  screening layer. Arrows indicate dominant O$_2$ diffusion toward and
  H$_2$O$_2$ production away from the electrode.}
\label{fig:domain}
\end{figure}
...
\bibitem{mangan2025}
N.~Mangan \emph{et al.},
``Electrochemical Kinetics of Oxygen Reduction on Rotating Disk Electrodes,''
\emph{Catalysis}, 2025.
