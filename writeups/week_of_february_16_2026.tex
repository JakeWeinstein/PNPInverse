...
\toprule
Case & Best $\kappa_0$ & Best $\kappa_1$ & Final Objective & Mean $|\Delta F/F|$ (\%) & Max $|\Delta F/F|$ (\%) \\
\midrule
0\% noise & 1.0015 & 1.9980 & $1.49\times 10^{-8}$ & 0.000 & 0.000 \\
5\% noise & 3.3216 & 1.5005 & $3.67\times 10^{-3}$ & 3.357 & 10.520 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{assets/robin_data_generation_0pct.png}
\caption{Synthetic Robin flux-curve data generation with 0\% noise.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{assets/robin_data_generation_5pct.png}
\caption{Synthetic Robin flux-curve data generation with 5\% RMS Gaussian noise.}
\end{figure}
