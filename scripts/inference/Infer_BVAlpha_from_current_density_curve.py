...
Recovers [alpha_1, alpha_2] for the 2-species coupled BV model (O2 + H2O2)
from a synthetic current-density vs. overpotential curve, with k0 values
held fixed at their true values.
...
Usage (from PNPInverse/ directory)::
    ...
    python scripts/inference/Infer_BVAlpha_from_current_density_curve.py
"""
...
def main() -> None:
    ...
    output_dir = os.path.join("StudyResults", "bv_alpha_inference")
    ...
    request = BVFluxCurveInferenceRequest(
        ...
        observable_title="BV alpha inference from I-V curve",
        # Control mode
        control_mode="alpha",
