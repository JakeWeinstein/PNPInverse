...
Recovers [k0_1, k0_2, alpha_1, alpha_2] simultaneously using adjoint-gradient
+ L-BFGS-B, with the Poisson-coupled EDL.
...
Usage (from PNPInverse/ directory)::
    ...
    python scripts/inference/Infer_BVJoint_charged_from_current_density_curve.py
"""
...
def main() -> None:
    ...
    output_dir = os.path.join("StudyResults", "bv_joint_inference_charged")
    ...
    request = BVFluxCurveInferenceRequest(
        ...
        observable_title="Charged 4-species joint (k0, alpha) inference from I-V curve",
        # Control mode
        control_mode="joint",
        # k0 bounds
        k0_lower=1e-8,
    ...
    print("\n=== Redimensionalized Joint Inference Results (Charged 4-Species) ===")
