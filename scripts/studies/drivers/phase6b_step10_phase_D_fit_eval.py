...
def _build_sp_for_phase_D(
    ...
    * ``override_sigma_singh_counts_pm2`` for the ablation path.
    ...
    """
    from scripts.studies.drivers.phase6b_v10a_v_sweep_diagnostic import _build_sp
...
def _make_mesh():
    ...
    from scripts.studies.drivers.phase6b_v10a_v_sweep_diagnostic import _make_mesh
    return _make_mesh()
...
def _per_v_lambda_ramp(
    *,
    ...
    :func:`scripts.studies.drivers.phase6b_v10a_phase_A2_v_kin.augment_rung_diagnostics`
