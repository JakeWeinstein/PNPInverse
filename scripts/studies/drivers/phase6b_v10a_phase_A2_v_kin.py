...
* Two-stage anchor: build at ``C_S = 0.10`` (convergence-pinned),
  ...
  :func:`scripts.studies.drivers.phase6b_v10a_v_sweep_diagnostic._walk_lambda_zero_capture_snapshots`.
...
def _parse_lambda_ladder(raw: Optional[str]) -> Tuple[float, ...]:
    ...
    :mod:`scripts.studies.drivers.phase6b_v10a_v_sweep_diagnostic` -- preserving
