"""Unified-interface example: infer diffusion ``D`` using Robin forward solver."""
...
def main() -> None:
    ...
    print("=== Diffusion Inference with Robin Solver (Unified Interface) ===")
    print(f"True D: {request.true_value}")
    print(f"Initial guess: {request.initial_guess}")
    print(f"Estimated D: {result.estimate}")
